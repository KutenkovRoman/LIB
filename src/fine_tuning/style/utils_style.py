...
class DatasetBuilder:
    ...
    def apply_limits(self, questions, answers, is_eval=False):
        ...
        if max_len is not None:
            ...
            answers = answers[:max_len] ## do we use the same max_len for answers as well?
    ...
    def get_data(self):
        ...
        # Apply limits (truncate if neccessary)
...
class DatasetRegistry:
    ...
    def set_dataset_paths(cls, args):
        ...
        if args.dataset in cls.DATASET_PATHS:
            args.dataset_path = {cls.DATASET_PATHS[args.dataset]} ## do we need curly braces here?
